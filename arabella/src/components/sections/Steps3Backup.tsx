// Backup da seção "Seu site em 3 passos" para reutilização futura.
import { useEffect, useMemo, useState } from 'react';
import { Globe, Info, ReceiptText, Rocket, Send, Share2, Timer } from 'lucide-react';
